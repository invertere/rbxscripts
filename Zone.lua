...
local Enum_ = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/Enum/init.lua"))()
local enum = Enum_.enums
local Janitor = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/Janitor.lua"))()
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/Signal.lua"))()
local ZonePlusReference = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/ZonePlusReference.lua"))()
local referenceObject = ZonePlusReference.getObject()
local ZoneController = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/ZoneController/init.lua"))()
...
function Zone:trackItem(instance)
	...
	local Tracker = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/ZoneController/Tracker.lua"))()
...
function Zone:relocate()
	...
	local CollectiveWorldModel = loadstring(game:HttpGet("https://raw.githubusercontent.com/1ForeverHD/ZonePlus/main/src/Zone/ZoneController/CollectiveWorldModel.lua"))()
